...
export function PlayerScoreCard({ displayName, photoURL, score, wins, isCurrentTurn }: PlayerScoreCardProps) {
  return (
    <div className={`${styles.card} ${isCurrentTurn ? styles.cardActive : ""}`}>
      <div className={styles.identity}>
        <PlayerBadge displayName={displayName} photoURL={photoURL} size="md" wins={wins} />
